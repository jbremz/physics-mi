# modified from `004-multi-task/train.py` to:
#   - reduce N epochs to 1000
#   - add another layer to network
#   - removed unit square input evaluation
#   - refactored to generate_data in new function
...
def generate_data(n_samples=10000, eps=0.5):
    # Initial generation
...
if __name__ == "__main__":
    ...
    for repeat in tqdm(range(repeats)):
        ...
        X_train, Y_train, X_valid, Y_valid = generate_data(10000, 0.5)
